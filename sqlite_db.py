...
add_to_user_comment("harryedu", "Edwin", "Nice work, keep it up bro")
add_to_user_comment("peterN", "peter ngacha", "This app is awsome, now i will be visiting your github regularly")
