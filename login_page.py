            ...
            if full_name and email:
                ...
                with st.expander("View comments"):
                    ...
                    for index, com in enumerate(results):
                        st.markdown(f"""
                                    <div style="background-color:black; width:100%; min-height:200px; position:relative"; overflow:auto;>
                                        ...
                                        <p style="font-family: courier; position:absolute; left:2%; top:30%; color:green;">{com[3]}<p>
                                    </div>
