                    ...
                    for index, com in enumerate(results):
                        st.markdown(f"""
                                    <div style="background-color:black; width:100%; height:200px; position:relative"; overflow:auto;>
                                        <h4 style="color:red; position:absolute; left:2%; top:30%; font-family:sans-serif; text-transform:capitalize;">{index + 1}. {com[2]} &nbsp;<span style="color:blue";font-size:8px;>time: {com[4]}</span></h4>
